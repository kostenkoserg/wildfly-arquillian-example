...
import com.fasto.datamanager.EntryService;
import com.fasto.datamanager.LineupService;
import com.fasto.datamanager.StockQuotesService;
...
public class TestServiceImpl implements TestService {
  ...
  final static Log logger = LogFactory.getLog(TestServiceImpl.class);
  ...
  public void setTournamentStatus(long tournamentId, TournamentStatus status) {
    ...
    TestEntity entity = entityManager.find(TestEntity.class, tournamentId);
  ...
  public TournamentState generateTournamentState(long tournamentId) {
    ...
    TestEntity tournamentEntity = entityManager.find(TestEntity.class, tournamentId);
  ...
  public TournamentDto getTournamentDetails(Long tournamentId) {
    ...
    TestEntity tournamentEntity
        = entityManager.find(TestEntity.class, tournamentId);
  ...
  public long createEntry(long playerId, long tournamentId, long lineUpId) {
    ...
    entity.setPlayerEntity(entityManager.find(PlayerEntity.class, playerId));
    entity.setTournamentEntity(entityManager.find(TestEntity.class, tournamentId));
